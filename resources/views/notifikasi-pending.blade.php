    ...
    <div class="row justify-content-center min-vh-100 align-items-center">
        <div class="col-md-5">
            <div class="card shadow card-body border-0">
                ...
                <h3 class="text-center">Masih Menunggu!</h3>
                <p class="text-center">Transaksi anda telah berhasil, namun pembayaran belum dilakukan. Silahkan cek status di tautan <a href="{{ route('invoice-main') }}">Berikut ini</a>.</p>
