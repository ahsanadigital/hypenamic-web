                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    <h5
                                        style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">
                                        Hi Candy<br>Purchase and get lifetime update!</h5>
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Say hello to
                                        version 1.1. Introducing email template with massaging application concept and
                                        as always modern, clean and easier to use.</p>
                                    <p style="margin-bottom: 15px;">Hope you'll enjoy the experience, we're here if you
                                        have any questions, drop us a line at info@yourwebsite.com anytime. </p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    ...
                                    <ul style="margin: 10px -4px 0;padding: 0;">
                                        ...
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff"
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a
                                        registered user of <a style="color: #6576ff; text-decoration:none;"
                                            href="https://softnio.com">softnio.com</a>. To update your emails
                                        preferences <a style="color: #6576ff; text-decoration:none;" href="#">click
                                            here</a>.</p>
                                </td>
                            </tr>
                        </tbody>
