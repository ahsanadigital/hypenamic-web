    ...
    <div class="row justify-content-center min-vh-100 align-items-center">
        <div class="col-md-5">
            <div class="card shadow card-body border-0">
                ...
                <h3 class="text-center">Berhasil!</h3>
                <p class="text-center">Sistem mendeteksi bahwa tiket sudah dikirim ke email anda, tiket akan dikirimkan kembali ke email anda. Selamat mengikuti kegiatan dengan nyaman.</p>
